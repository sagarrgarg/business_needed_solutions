                        ...
                        if (customer_result && customer_result.is_bns_internal_customer) {
                            ...
                            if (needs_conversion) {
                                ...
                                frm.add_custom_button(__('Convert to BNS Internal'), function() {
                                    // Get DN details
                                    frappe.call({
                                        method: 'business_needed_solutions.bns_internal_transfer.utils.get_delivery_note_by_supplier_delivery_note',
                                        args: {
                                        ...
                                        callback: function(dn_result) {
                                            ...
                                            const d = new frappe.ui.Dialog({
                                                ...
                                                primary_action(values) {
                                                    frappe.call({
                                                        method: 'business_needed_solutions.bns_internal_transfer.utils.convert_purchase_receipt_to_bns_internal',
                                                        args: {
                                                            purchase_receipt: frm.doc.name,
