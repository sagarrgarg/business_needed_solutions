            ...
            frappe.db.get_value("Customer", frm.doc.customer, "is_bns_internal_customer", (r) => {
                if (r && r.is_bns_internal_customer) {
                    ...
                    frm.add_custom_button(__('Convert to BNS Internal'), function() {
                        ...
                        frappe.call({
                            method: 'business_needed_solutions.bns_internal_transfer.utils.get_purchase_invoice_by_supplier_invoice',
                            args: {
                                        ...
                                        if (values.purchase_invoice) {
                                            ...
                                            frappe.call({
                                                ...
                                                callback: function(validation_result) {
                                                    ...
                                                    frappe.call({
                                                        method: 'business_needed_solutions.bns_internal_transfer.utils.convert_sales_invoice_to_bns_internal',
                                                        args: {
                                                            sales_invoice: frm.doc.name,
                                                            purchase_invoice: values.purchase_invoice
                                                        },
            ...
            frm.add_custom_button(
                ...
                function() {
                    frappe.model.open_mapped_doc({
                        method: "business_needed_solutions.bns_internal_transfer.utils.make_bns_internal_purchase_invoice",
                        frm: frm,
                    });
                },
                __("Create")
            ...
            if (frm.doc.items && frm.doc.items.length > 0) {
                ...
                if (has_dn_reference) {
                    ...
                    frm.add_custom_button(
                        ...
                        function() {
                            frappe.model.open_mapped_doc({
                                method: "business_needed_solutions.bns_internal_transfer.utils.make_bns_internal_purchase_receipt_from_si",
                                frm: frm,
                            });
                        },
                        __("Create")
