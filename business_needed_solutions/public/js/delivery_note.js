                ...
                if (r && r.is_bns_internal_customer) {
                    ...
                    if (needs_conversion) {
                        ...
                        frm.add_custom_button(__('Convert to BNS Internal'), function() {
                            ...
                            frappe.call({
                                method: 'business_needed_solutions.bns_internal_transfer.utils.get_purchase_receipt_by_supplier_delivery_note',
                                args: {
                                ...
                                callback: function(pr_result) {
                                    ...
                                    const d = new frappe.ui.Dialog({
                                        ...
                                        primary_action(values) {
                                            frappe.call({
                                                method: 'business_needed_solutions.bns_internal_transfer.utils.convert_delivery_note_to_bns_internal',
                                                args: {
                                                    delivery_note: frm.doc.name,
                ...
                frm.add_custom_button(
                    ...
                    function() {
                        frappe.model.open_mapped_doc({
                            method: "business_needed_solutions.bns_internal_transfer.utils.make_bns_internal_purchase_receipt",
                            frm: frm,
                        });
                    },
                    __("Create")
            ...
            if (frm.doc.bns_inter_company_reference) {
                ...
                frm.add_custom_button(__('Unlink Purchase Receipt'), function() {
                    frappe.confirm(
                        ...
                        function() {
                            frappe.call({
                                method: 'business_needed_solutions.bns_internal_transfer.utils.unlink_dn_pr',
                                args: {
                                    delivery_note: frm.doc.name
                                },
                                freeze: true,
                ...
                frm.add_custom_button(__('Link Purchase Receipt'), function() {
                    ...
                    const d = new frappe.ui.Dialog({
                        ...
                        primary_action(values) {
                            ...
                            frappe.call({
                                method: 'business_needed_solutions.bns_internal_transfer.utils.link_dn_pr',
                                args: {
                                    delivery_note: frm.doc.name,
