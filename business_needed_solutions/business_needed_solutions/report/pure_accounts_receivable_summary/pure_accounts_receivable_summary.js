...
frappe.query_reports["Pure Accounts Receivable Summary"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		{
			fieldname: "exclude_customer_group",
			label: __("Exclude Customer Group"),
			fieldtype: "MultiSelectList",
			get_data: function(txt) {
...
erpnext.utils.add_dimensions("Pure Accounts Receivable Summary", 9);
