...
doc_events = {
    ...
    "Delivery Note": {
        "validate": [
            ...
            "business_needed_solutions.bns_branch_accounting.billing_location.validate_billing_location"
        ],
        "on_submit": [
    ...
    "Sales Invoice": {
        "validate": [
            ...
            "business_needed_solutions.bns_branch_accounting.utils.validate_sales_invoice_company_address_from_dn",
            "business_needed_solutions.bns_branch_accounting.billing_location.validate_billing_location"
        ],
        "on_submit": [
            "business_needed_solutions.business_needed_solutions.overrides.submission_restriction.validate_submission_permission",
    ...
    "Sales Order": {
        "validate": "business_needed_solutions.bns_branch_accounting.billing_location.validate_billing_location",
        "on_submit": "business_needed_solutions.business_needed_solutions.overrides.submission_restriction.validate_submission_permission"
    },
    "Purchase Order": {
        "on_submit": "business_needed_solutions.business_needed_solutions.overrides.submission_restriction.validate_submission_permission"
