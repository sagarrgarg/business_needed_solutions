...
- [[Find DNs where a submitted PR references the DN but DN has no back-reference.]] - rationale - business_needed_solutions/bns_branch_accounting/report/internal_transfer_receive_mismatch/internal_transfer_receive_mismatch.py
...
- [[Query to fetch only company addresses for the report filter.  	Why the searchfie]] - rationale - business_needed_solutions/bns_branch_accounting/report/internal_transfer_receive_mismatch/internal_transfer_receive_mismatch.py
...
- [[get_asymmetric_reference_mismatches()]] - code - business_needed_solutions/bns_branch_accounting/report/internal_transfer_receive_mismatch/internal_transfer_receive_mismatch.py
...
```dataview
TABLE source_file, type FROM #community/Transfer_Receive_Mismatch
SORT file.name ASC
```
