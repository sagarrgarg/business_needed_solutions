...
```dataview
TABLE source_file, type FROM #community/Core_Utils_&_Runtime_Patches
SORT file.name ASC
```

## Connections to other communities
- 18 edges to [[_COMMUNITY_PR Return Linking & Internal Supplier]]
- 8 edges to [[_COMMUNITY_PIDN Item Bundle Linking]]
- 4 edges to [[_COMMUNITY_Utils BatchSerial Parity]]
- 3 edges to [[_COMMUNITY_Submission & Stock Validation]]
- 3 edges to [[_COMMUNITY_Utils Cancel Linked Docs]]
- 2 edges to [[_COMMUNITY_Utils BNS Internal DNPR Scope]]
- 2 edges to [[_COMMUNITY_Utils Purchase Cancel Unlinking]]

## Top bridge nodes
- [[utils.py]] - degree 207, connects to 7 communities
- [[BNSValidationError]] - degree 19, connects to 1 community
- [[update_purchase_receipt_status_for_bns_internal()]] - degree 11, connects to 1 community
- [[_get_representing_company_from_customer()]] - degree 7, connects to 1 community
- [[_update_details_pr_from_si()]] - degree 7, connects to 1 community