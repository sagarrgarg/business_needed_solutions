...
# _validate_purchase_invoice_references()

## Connections
- [[Validate that all stock items in Purchase Invoice are referenced from Purchase R]] - `rationale_for` [EXTRACTED]
- [[_get_non_referenced_stock_items()]] - `calls` [EXTRACTED]
- [[_raise_purchase_invoice_reference_error()]] - `calls` [EXTRACTED]
