...
# get_purchase_receipt_by_supplier_delivery_note()

## Connections
- [[Find Purchase Receipt by supplier_delivery_note matching Delivery Note name.]] - `rationale_for` [EXTRACTED]
- [[_bns_require_accounts_read()]] - `calls` [EXTRACTED]
