...
```dataview
TABLE source_file, type FROM #community/_check_dn_pr_fixable()
SORT file.name ASC
```

## Connections to other communities
- 18 edges to [[_COMMUNITY_utils.py]]

## Top bridge nodes
- [[_detect_chain_type()]] - degree 12, connects to 1 community
- [[_qtys_equal_bulk()]] - degree 8, connects to 1 community
- [[verify_and_repost_internal_transfers()]] - degree 7, connects to 1 community
